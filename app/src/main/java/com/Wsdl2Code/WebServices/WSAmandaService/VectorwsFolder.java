...
public class VectorwsFolder extends Vector<wsFolder> implements KvmSerializable_ws {
    
    
    public VectorwsFolder(){}
    
    public VectorwsFolder(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
