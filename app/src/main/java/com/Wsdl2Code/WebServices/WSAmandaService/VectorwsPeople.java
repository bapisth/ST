...
public class VectorwsPeople extends Vector<wsPeople> implements KvmSerializable_ws {
    
    
    public VectorwsPeople(){}
    
    public VectorwsPeople(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
