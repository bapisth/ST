...
public class addFolderFixtureResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public addFolderFixtureResponse(){}
    
    public addFolderFixtureResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
