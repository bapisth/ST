...
public class addFolderPropertyResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public addFolderPropertyResponse(){}
    
    public addFolderPropertyResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
