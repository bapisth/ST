...
public class addPeopleGroupMemberResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public addPeopleGroupMemberResponse(){}
    
    public addPeopleGroupMemberResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
