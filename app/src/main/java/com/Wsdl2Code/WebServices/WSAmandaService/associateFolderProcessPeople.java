...
public class associateFolderProcessPeople implements KvmSerializable_ws {
    ...
    public associateFolderProcessPeople(){}
    
    public associateFolderProcessPeople(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
