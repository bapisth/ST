...
public class associatePartyToPeople implements KvmSerializable_ws {
    
    public int folderRSN;
    public boolean folderRSNSpecified;
    public int peopleRSN;
    public boolean peopleRSNSpecified;
    public VectorInt32 peopleRSNToBeAssociated;
    
    public associatePartyToPeople(){}
    
    public associatePartyToPeople(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("peopleRSNToBeAssociated"))
        {
            SoapObject j = (SoapObject)soapObject.getProperty("peopleRSNToBeAssociated");
            peopleRSNToBeAssociated = new VectorInt32(j);
        }
    }
    @Override
    public Object getProperty(int arg0) {
        switch(arg0){
            ...
            case 4:
                return peopleRSNToBeAssociated;
        }
        return null;
    }
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        switch(index){
            ...
            case 4:
                ...
                info.name = "peopleRSNToBeAssociated";
                break;
        }
    }
