...
public class deleteAttachmentInfoResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public deleteAttachmentInfoResponse(){}
    
    public deleteAttachmentInfoResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
