...
public class deleteFolderFixtureResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public deleteFolderFixtureResponse(){}
    
    public deleteFolderFixtureResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
