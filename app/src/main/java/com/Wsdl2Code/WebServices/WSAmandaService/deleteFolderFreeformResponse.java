...
public class deleteFolderFreeformResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public deleteFolderFreeformResponse(){}
    
    public deleteFolderFreeformResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
