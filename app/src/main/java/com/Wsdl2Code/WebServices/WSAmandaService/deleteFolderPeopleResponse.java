...
public class deleteFolderPeopleResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public deleteFolderPeopleResponse(){}
    
    public deleteFolderPeopleResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
