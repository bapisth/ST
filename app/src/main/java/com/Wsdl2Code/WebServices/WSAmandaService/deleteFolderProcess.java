...
public class deleteFolderProcess implements KvmSerializable_ws {
    
    public int folderRSN;
    public boolean folderRSNSpecified;
    public VectorInt32 processRSN;
    
    public deleteFolderProcess(){}
    
    public deleteFolderProcess(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        {
            SoapObject j = (SoapObject)soapObject.getProperty("processRSN");
            processRSN = new VectorInt32(j);
        }
    }
    @Override
