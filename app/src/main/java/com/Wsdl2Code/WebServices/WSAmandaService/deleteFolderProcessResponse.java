...
public class deleteFolderProcessResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public deleteFolderProcessResponse(){}
    
    public deleteFolderProcessResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
