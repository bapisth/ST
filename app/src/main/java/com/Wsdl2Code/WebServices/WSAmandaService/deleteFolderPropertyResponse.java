...
public class deleteFolderPropertyResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public deleteFolderPropertyResponse(){}
    
    public deleteFolderPropertyResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
