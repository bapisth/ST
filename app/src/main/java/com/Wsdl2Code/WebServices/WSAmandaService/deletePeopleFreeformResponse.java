...
public class deletePeopleFreeformResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public deletePeopleFreeformResponse(){}
    
    public deletePeopleFreeformResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
