...
public class getAttachmentInfoByInfoCode implements KvmSerializable_ws {
    
    public int attachmentRSN;
    public boolean attachmentRSNSpecified;
    public VectorInt32 attachmentInfoCode;
    
    public getAttachmentInfoByInfoCode(){}
    
    public getAttachmentInfoByInfoCode(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
