...
public class getFolderByProcessPeople implements KvmSerializable_ws {
    
    public int peopleRSN;
    public boolean peopleRSNSpecified;
    
    public getFolderByProcessPeople(){}
    
    public getFolderByProcessPeople(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
