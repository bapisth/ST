...
public class getFolderChargeByFolderRSN implements KvmSerializable_ws {
    
    public int folderRSN;
    public boolean folderRSNSpecified;
    
    public getFolderChargeByFolderRSN(){}
    
    public getFolderChargeByFolderRSN(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
