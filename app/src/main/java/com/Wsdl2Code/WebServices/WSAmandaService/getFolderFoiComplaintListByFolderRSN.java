...
public class getFolderFoiComplaintListByFolderRSN implements KvmSerializable_ws {
    
    public int folderRSN;
    public boolean folderRSNSpecified;
    public int complaintFolderRSN;
    public boolean complaintFolderRSNSpecified;
    
    public getFolderFoiComplaintListByFolderRSN(){}
    
    public getFolderFoiComplaintListByFolderRSN(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("complaintFolderRSNSpecified"))
        {
            Object obj = soapObject.getProperty("complaintFolderRSNSpecified");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                complaintFolderRSNSpecified = Boolean.parseBoolean(j.toString());
            }else if (obj!= null && obj instanceof Boolean){
                complaintFolderRSNSpecified = (Boolean) obj;
            }
        }
    }
    @Override
    public Object getProperty(int arg0) {
        switch(arg0){
            ...
            case 3:
                return complaintFolderRSNSpecified;
        }
        return null;
    }
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        switch(index){
            ...
            case 3:
                info.type = PropertyInfo.BOOLEAN_CLASS;
                info.name = "complaintFolderRSNSpecified";
                break;
        }
    }
