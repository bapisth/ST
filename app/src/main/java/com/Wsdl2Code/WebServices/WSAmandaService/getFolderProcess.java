...
public class getFolderProcess implements KvmSerializable_ws {
    
    public int folderRSN;
    public boolean folderRSNSpecified;
    public VectorInt32 processGroups;
    
    public getFolderProcess(){}
    
    public getFolderProcess(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("processGroups"))
        {
            SoapObject j = (SoapObject)soapObject.getProperty("processGroups");
            processGroups = new VectorInt32(j);
        }
    }
    @Override
