...
public class getFolderProcessAttemptByCode implements KvmSerializable_ws {
    ...
    public getFolderProcessAttemptByCode(){}
    
    public getFolderProcessAttemptByCode(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
