...
public class getFolderProcessAttempts implements KvmSerializable_ws {
    
    public int processRSN;
    public boolean processRSNSpecified;
    
    public getFolderProcessAttempts(){}
    
    public getFolderProcessAttempts(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
