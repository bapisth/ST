...
public class getFolderSubByFolderType implements KvmSerializable_ws {
    
    public String folderType;
    public String webDisplayFlag;
    
    public getFolderSubByFolderType(){}
    
    public getFolderSubByFolderType(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
