...
public class getPeopleResponse implements KvmSerializable_ws {
    
    public wsPeople returnField;
    
    public getPeopleResponse(){}
    
    public getPeopleResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
