...
public class getProcessFreeFormByCode implements KvmSerializable_ws {
    
    public int processRSN;
    public boolean processRSNSpecified;
    public VectorInt32 freeFormCode;
    
    public getProcessFreeFormByCode(){}
    
    public getProcessFreeFormByCode(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
