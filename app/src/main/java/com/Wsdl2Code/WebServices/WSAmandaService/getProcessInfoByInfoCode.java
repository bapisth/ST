...
public class getProcessInfoByInfoCode implements KvmSerializable_ws {
    
    public int processRSN;
    public boolean processRSNSpecified;
    public VectorInt32 infoCodes;
    
    public getProcessInfoByInfoCode(){}
    
    public getProcessInfoByInfoCode(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
