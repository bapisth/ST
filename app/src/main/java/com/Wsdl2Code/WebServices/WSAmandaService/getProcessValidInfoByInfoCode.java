...
public class getProcessValidInfoByInfoCode implements KvmSerializable_ws {
    
    public int infoCode;
    public boolean infoCodeSpecified;
    
    public getProcessValidInfoByInfoCode(){}
    
    public getProcessValidInfoByInfoCode(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
