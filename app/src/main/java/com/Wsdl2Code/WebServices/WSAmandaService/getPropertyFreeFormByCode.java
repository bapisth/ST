...
public class getPropertyFreeFormByCode implements KvmSerializable_ws {
    
    public int propertyRSN;
    public boolean propertyRSNSpecified;
    public VectorInt32 freeFormCode;
    
    public getPropertyFreeFormByCode(){}
    
    public getPropertyFreeFormByCode(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        {
            SoapObject j = (SoapObject)soapObject.getProperty("freeFormCode");
            freeFormCode = new VectorInt32(j);
        }
    }
    @Override
