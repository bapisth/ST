...
public class getPropertyInfoByInfoCode implements KvmSerializable_ws {
    
    public int propertyRSN;
    public boolean propertyRSNSpecified;
    public VectorInt32 infoCodes;
    
    public getPropertyInfoByInfoCode(){}
    
    public getPropertyInfoByInfoCode(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("infoCodes"))
        {
            SoapObject j = (SoapObject)soapObject.getProperty("infoCodes");
            infoCodes = new VectorInt32(j);
        }
    }
    @Override
