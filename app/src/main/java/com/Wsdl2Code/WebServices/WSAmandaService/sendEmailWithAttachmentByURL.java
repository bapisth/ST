...
public class sendEmailWithAttachmentByURL implements KvmSerializable_ws {
    ...
    public VectorString attachmentPath;
    public String body;
    
    public sendEmailWithAttachmentByURL(){}
    
    public sendEmailWithAttachmentByURL(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("attachmentPath"))
        {
            SoapObject j = (SoapObject)soapObject.getProperty("attachmentPath");
            attachmentPath = new VectorString(j);
        }
