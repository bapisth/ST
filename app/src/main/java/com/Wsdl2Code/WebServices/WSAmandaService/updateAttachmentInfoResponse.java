...
public class updateAttachmentInfoResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public updateAttachmentInfoResponse(){}
    
    public updateAttachmentInfoResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
