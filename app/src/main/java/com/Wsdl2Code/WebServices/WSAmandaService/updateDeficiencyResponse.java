...
public class updateDeficiencyResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public updateDeficiencyResponse(){}
    
    public updateDeficiencyResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
