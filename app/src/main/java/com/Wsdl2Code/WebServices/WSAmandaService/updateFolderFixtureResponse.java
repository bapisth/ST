...
public class updateFolderFixtureResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public updateFolderFixtureResponse(){}
    
    public updateFolderFixtureResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
