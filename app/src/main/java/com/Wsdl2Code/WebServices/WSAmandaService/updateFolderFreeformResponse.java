...
public class updateFolderFreeformResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public updateFolderFreeformResponse(){}
    
    public updateFolderFreeformResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
