...
public class updateFolderInfoResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public updateFolderInfoResponse(){}
    
    public updateFolderInfoResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
