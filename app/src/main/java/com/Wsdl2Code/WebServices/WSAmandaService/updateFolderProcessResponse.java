...
public class updateFolderProcessResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public updateFolderProcessResponse(){}
    
    public updateFolderProcessResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
