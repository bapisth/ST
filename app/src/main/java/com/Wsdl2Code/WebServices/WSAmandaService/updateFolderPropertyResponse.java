...
public class updateFolderPropertyResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public updateFolderPropertyResponse(){}
    
    public updateFolderPropertyResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
