...
public class updatePeopleFreeformResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public updatePeopleFreeformResponse(){}
    
    public updatePeopleFreeformResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
