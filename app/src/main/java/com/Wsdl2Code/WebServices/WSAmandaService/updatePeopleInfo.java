...
//
import com.Wsdl2Code.WebServices.WSAmandaService.VectorwsPeopleInfo;
...
public class updatePeopleInfo implements KvmSerializable_ws {
    
    public int peopleRSN;
    public boolean peopleRSNSpecified;
    public VectorwsPeopleInfo peopleInfo;
    
    public updatePeopleInfo(){}
    
    public updatePeopleInfo(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("peopleInfo"))
        {
            SoapObject j = (SoapObject)soapObject.getProperty("peopleInfo");
            peopleInfo = new VectorwsPeopleInfo(j);
        }
    }
    @Override
