...
public class updatePeopleInternetPassword implements KvmSerializable_ws {
    
    public int peopleRSN;
    public boolean peopleRSNSpecified;
    public String internetPassword;
    
    public updatePeopleInternetPassword(){}
    
    public updatePeopleInternetPassword(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
