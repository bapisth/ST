...
//
import com.Wsdl2Code.WebServices.WSAmandaService.VectorwsPropertyInfo;
...
public class updatePropertyInfo implements KvmSerializable_ws {
    
    public int propertyRSN;
    public boolean propertyRSNSpecified;
    public VectorwsPropertyInfo propertyInfo;
    
    public updatePropertyInfo(){}
    
    public updatePropertyInfo(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("propertyInfo"))
        {
            SoapObject j = (SoapObject)soapObject.getProperty("propertyInfo");
            propertyInfo = new VectorwsPropertyInfo(j);
        }
    }
    @Override
