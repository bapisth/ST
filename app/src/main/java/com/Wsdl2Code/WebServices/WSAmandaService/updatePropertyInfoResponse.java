...
public class updatePropertyInfoResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public updatePropertyInfoResponse(){}
    
    public updatePropertyInfoResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
