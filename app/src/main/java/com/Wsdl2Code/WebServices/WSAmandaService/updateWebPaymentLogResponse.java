...
public class updateWebPaymentLogResponse implements KvmSerializable_ws {
    
    public boolean returnField;
    
    public updateWebPaymentLogResponse(){}
    
    public updateWebPaymentLogResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
