...
public class wsValidAttachmentInfoValue implements KvmSerializable_ws {
    ...
    public wsValidAttachmentInfoValue(){}
    
    public wsValidAttachmentInfoValue(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
